...
carac = pd.read_csv("D:/Bruno/Programmation/Data/Assurance_véhicule/caracteristiques.csv", sep = ';')
lieux= pd.read_csv("D:/Bruno/Programmation/Data/Assurance_véhicule/lieux.csv", sep = ";")
usagers = pd.read_csv("D:/Bruno/Programmation/Data/Assurance_véhicule/usagers.csv", sep = ';')
vehic = pd.read_csv("D:/Bruno/Programmation/Data/Assurance_véhicule/vehicules.csv", sep = ';')
